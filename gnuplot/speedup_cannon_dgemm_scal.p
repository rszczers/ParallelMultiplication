...
set style line 5 lc rgb "#F8B195" pt 5 ps 1 lt 5 lw 2
...
set label "Algorytm naiwny" at  100, 1.7
plot 'data/scal_cannon_dgemm_1.dat' u 5:(mean_seq/$1):xticlabel(5) w linesp t 'Cannon-DGEMM, 1 wątek' ls 1, \
'data/scal_cannon_dgemm_4.dat' u 5:(mean_seq/$1) w linesp t 'Cannon-DGEMM, 4 wątki' ls 2, \
'data/scal_cannon_dgemm_12.dat' u 5:(mean_seq/$1) w linesp t 'Cannon-DGEMM, 12 wątków' ls 3, \
