...
plot 'data/scal_cannon_omp_1.dat' u (mean_seq/$1):xticlabel(5) w linesp t 'Cannon-OMP, 1 wątek' ls 1, \
'data/scal_cannon_omp_4.dat' u (mean_seq/$1):xticlabel(5) w linesp t 'Cannon-OMP, 4 wątków' ls 2, \
'data/scal_cannon_omp_12.dat' u (mean_seq/$1):xticlabel(5) w linesp t 'Cannon-OMP, 12 wątków' ls 3, \
