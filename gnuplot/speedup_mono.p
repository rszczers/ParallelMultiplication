...
set terminal epslatex size 13cm,9cm color colortext header \
...
plot 'data/8192_omp.dat' u 6:(mean_seq/$1) w linesp t 'OMP parfor' ls 1, \
'data/8192_mkl.dat' u 6:(mean_seq/$1) w linesp t 'MKL DGEMM' ls 2, \
1 ls 8 notitle
